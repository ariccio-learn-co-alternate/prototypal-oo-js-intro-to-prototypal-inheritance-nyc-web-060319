...
something else with more specification added. Everything new is based on of a
pre-existing pattern, a first of its kind, the proto(first) - typos(kind), or
_prototype_.

* An Poodle is based on the Water-Dog breed...
* ...and a Water-Dogs are breeds based on of Dogs...
